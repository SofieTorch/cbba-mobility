...
def upgrade() -> None:
    ...
    op.create_geospatial_table('recording_sessions',
    ...
    sa.Column('status', sa.Enum('IN_PROGRESS', 'COMPLETED', 'CANCELLED', 'ABANDONED', name='recordingstatus'), nullable=False),
    ...
    op.create_geospatial_index('idx_recording_sessions_computed_path', 'recording_sessions', ['computed_path'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    op.create_geospatial_table('routes',
    ...
    op.create_geospatial_index('idx_routes_path', 'routes', ['path'], unique=False, postgresql_using='gist', postgresql_ops={})
    op.create_index(op.f('ix_routes_line_id'), 'routes', ['line_id'], unique=False)
    op.create_geospatial_table('location_points',
    ...
    op.create_geospatial_index('idx_location_points_point', 'location_points', ['point'], unique=False, postgresql_using='gist', postgresql_ops={})
...
def downgrade() -> None:
    ...
    op.drop_geospatial_index('idx_location_points_point', table_name='location_points', postgresql_using='gist', column_name='point')
    ...
    op.drop_geospatial_index('idx_recording_sessions_computed_path', table_name='recording_sessions', postgresql_using='gist', column_name='computed_path')
